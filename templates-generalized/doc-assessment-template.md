...
2. **Developer documentation**: Note not all of this may exist or be located exactly where listed here - this list provides a general guide
   ...
   - Plan documents in `[DEV_DOCS]/plans/`
   - Completed plan documents in `[DEV_DOCS]/plans/`
