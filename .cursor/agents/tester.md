...
description: >-
  ...
  maintains logs/test-ledger.md, may request cloud runs for heavy suites,
  investigates failures without editing code. Use for test execution,
  coverage of plan test tasks, and reporting flaky or failing suites to
  orchestrator.
model: fast
readonly: false
---
