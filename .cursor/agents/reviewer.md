...
description: >-
  ...
  checks lints, edge cases, merge recommendation, and verification gates;
  updates plan checklists when verified; reports pass/fail to orchestrator.
  Use after implementation or for audit of alignment with specs.
model: inherit
readonly: false
---
