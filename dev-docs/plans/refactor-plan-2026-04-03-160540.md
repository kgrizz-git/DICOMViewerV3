...
## Progress snapshot (verified) — 2026-04-05 (Phase 3 row updated 2026-04-06; Phase 4 complete 2026-04-07; Phase 5A–5C slices 2026-04-07)
...
- [ ] **Phase 5** — **5A–5C first slices done** (2026-04-07); tracks **5D–5E** still open.
...
- [x] **AGENTS.md** — **`tools/roi_persistence.py`**, **`core/mpr_geometry.py`** (2026-04-07).
- [x] Discovery / extract **5C** — **`src/core/mpr_geometry.py`**; **`mpr_builder`** delegates (2026-04-07).
- [ ] Extract **5D–5E** per expanded-spec table when capacity allows.
- [x] Run full suite after **5C** — **352 passed** (2026-04-07); re-run after **5D–5E**.
