...
## Progress snapshot (verified) — 2026-04-05 (Phase 3 row updated 2026-04-06; Phase 4 complete 2026-04-07)
...
- [ ] Manual smoke: projection UI, QA/export/screenshot flows when touching those areas. *Prior note: exporting images/DICOM, pylinac CT, projection checked; pylinac MRI still worth a run.*
