...
- [x] **AGENTS.md** — **`tools/roi_persistence.py`**, **`core/mpr_geometry.py`**, **`gui/metadata_table_model.py`** (2026-04-08).
...
- [ ] Extract **5E** per expanded-spec table when capacity allows.
- [x] Run full suite after **5D** — **357 passed** (2026-04-08).
- [ ] **5E** track: always run **full** suite (undo/pylinac blast radius).
