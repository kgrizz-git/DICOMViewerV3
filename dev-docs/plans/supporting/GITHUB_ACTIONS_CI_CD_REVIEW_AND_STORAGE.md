...
- [ ] **Third-party actions:** Pin bumps go through the repo’s **[Dependency bump verification plan](../completed/DEPENDENCY_BUMP_VERIFICATION_PLAN.md)** when materially risky.
