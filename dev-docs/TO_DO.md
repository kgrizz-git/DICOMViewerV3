...
- [ ] **[P0]** Add measurements and ROI tools on MPR subwindows, including window/level ROIs ([plan: ROI/measure/slab](plans/MPR_MEASUREMENTS_ROI_TOOLS_AND_COMBINE_SLICES_PLAN.md), [plan: annotations & right-pane combine](plans/MPR_ANNOTATIONS_AND_RIGHT_PANE_COMBINE_SLICES_PLAN.md)) **implementing** — still need text and arrow annotation - **done?**
- [ ] **[P0]** Combine slices on MPR (MIP/MinIP/AIP options) ([plan: ROI/measure/slab](plans/MPR_MEASUREMENTS_ROI_TOOLS_AND_COMBINE_SLICES_PLAN.md), [plan: annotations & right-pane combine](plans/MPR_ANNOTATIONS_AND_RIGHT_PANE_COMBINE_SLICES_PLAN.md)) **implementing** — harmonize with usual right-pane “Combine Slices,” not only when making MPR. - **done?**
