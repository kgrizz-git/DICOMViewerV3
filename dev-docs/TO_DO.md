...
- [ ] **[P2]** **Retry the deferred SonarSource scan action and TruffleHog updates.** Dependabot PR #35 was superseded after TruffleHog’s SonarCloud detector falsely flagged Dependabot-style pinned Action SHAs. When TruffleHog releases its detector fix, open a clean update PR and require the blocking secret scan to pass; do not suppress the detector or weaken its verification policy.
