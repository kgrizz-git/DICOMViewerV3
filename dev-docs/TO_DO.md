...
- [ ] **[P0]** pylinac run on MRI has 'Sagittal Distortions: {}' - see [PYLINAC_SAGITTAL_DISTORTIONS_INVESTIGATION.md](info/PYLINAC_SAGITTAL_DISTORTIONS_INVESTIGATION.md). Why is it returning only empty brackets? should there be more content there? (Done: identified as missing sagittal slice in input dataset).
