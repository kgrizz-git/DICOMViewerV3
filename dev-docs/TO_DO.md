...
- [ ] **[P0]** Check dose RP values / order of magnitude / units for XA fluoroscopy RDSRs — [**plan**](plans/RDSR_XA_DOSE_RP_AND_SR_CLEAR_WINDOW_P0_PLAN.md#p0-xa-rdsr-dose-rp-units)
- [ ] **[P0]** Doing Clear this window on a window with SR does not clear the message or button — [**plan**](plans/RDSR_XA_DOSE_RP_AND_SR_CLEAR_WINDOW_P0_PLAN.md#p0-sr-clear-window-overlay)
