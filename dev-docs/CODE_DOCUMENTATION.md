...
**Code layout and architecture (for agents):** [`../ARCHITECTURE.md`](../ARCHITECTURE.md) (domain map), [`SOURCE_LAYOUT.md`](SOURCE_LAYOUT.md) (`src/` tree and signal wiring), [`HARNESS.md`](HARNESS.md) (verification scripts).
