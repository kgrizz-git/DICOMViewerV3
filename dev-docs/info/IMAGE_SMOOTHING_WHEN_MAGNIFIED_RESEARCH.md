...
- **Config**: Persisted setting `smooth_image_when_zoomed`, enabled by default for new or missing configs while preserving a user's saved disabled preference, with get/set API.
