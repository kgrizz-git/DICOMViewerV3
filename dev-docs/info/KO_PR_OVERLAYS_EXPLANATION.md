...
> **Also see:** [DICOM_GSPS_KO_SECONDARY_CAPTURE.md](DICOM_GSPS_KO_SECONDARY_CAPTURE.md) for GSPS/KO/SC concepts, PACS export plans, and **current read/write/display status** in DICOM Viewer V3 (including Secondary Capture and fusion save).
