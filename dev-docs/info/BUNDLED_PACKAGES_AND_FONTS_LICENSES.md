...
Detailed engineering strategy and option-by-option risks: [`PYLIBJPEG_ALTERNATIVES_AND_DICOM_DECODER_STRATEGY.md`](PYLIBJPEG_ALTERNATIVES_AND_DICOM_DECODER_STRATEGY.md).
