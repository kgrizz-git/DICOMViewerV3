...
| TRIAGE-038 | **Narrowed 2026-09-06:** slices 2b and 2c are complete, so 9 of the original 15 rows are now assessed. The rows still at `Baseline` are the user-facing set that needs a running UI, plus DOC-20: DOC-01, 06, 07, 08, 09, 10, 18, 19, 20 | DOC-01, DOC-06, DOC-07, DOC-08, DOC-09, DOC-10, DOC-18, DOC-19, DOC-20 | deferred | Phase 1 audited a first slice by design, but no phase or trigger was assigned to clear the remainder, so the rows had no owner. Slices 2b and 2c landed in [`doc-assessment-2026-09-06-234253.md`](doc-assessments/doc-assessment-2026-09-06-234253.md). Slice 2a remains: those rows require exercising fusion, MPR, 3D, annotations, anonymization, export, and pylinac QA in the running application. | [DOCUMENTATION_WORKFLOW_AND_FRESHNESS_PLAN.md — Phase 2](plans/DOCUMENTATION_WORKFLOW_AND_FRESHNESS_PLAN.md#phase-2--complete-the-accuracy-audit) | 2026-09-06 |
