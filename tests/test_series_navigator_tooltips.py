...
def test_build_instance_entries_for_navigator_deduplicates_original_dataset() -> None:
    original = Dataset()
    original.InstanceNumber = "7"

    split_frame_1 = Dataset()
    split_frame_1._original_dataset = original
    split_frame_1._frame_index = 0

    split_frame_2 = Dataset()
    split_frame_2._original_dataset = original
    split_frame_2._frame_index = 1

    second = Dataset()
    second.InstanceNumber = "8"

    entries = build_instance_entries_for_navigator([split_frame_1, split_frame_2, second])
