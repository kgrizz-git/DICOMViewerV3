...
class QuickStartGuideDialog(QDialog):
    ...
    def _get_guide_content(self) -> str:
        ...
        <body>
            ...
            <p><strong>Expand and revert:</strong> Double-click a pane (on the image or empty area) to expand it to full 1x1 view. Double-click again in 1x1 to revert to the previous layout (or 2x2). <strong>1x2</strong> shows the row (in the 2x2 grid) containing the focused window; <strong>2x1</strong> shows the column containing the focused window. In 2x2 layout, right-click → <strong>Swap</strong> → "Swap with Window 1/2/3/4" (1=top-left, 2=top-right, 3=bottom-left, 4=bottom-right) to exchange positions; contents stay with each view.</p>
            ...
            <ul>
                ...
                <li><strong>Show/Hide Series Navigator:</strong> Use <strong>View → Show/Hide Series Navigator</strong>, the toolbar button, key <code>N</code>, or right-click on image → "Show/Hide Series Navigator" to show or hide the series navigator bar at the bottom.</li>
            </ul>
            ...
            <ul>
                ...
                <li><strong><code>N</code>:</strong> Show/Hide Series Navigator bar. Also available via <strong>View → Show/Hide Series Navigator</strong> or right-click on image → "Show/Hide Series Navigator".</li>
            ...
            <ul>
                ...
                <li>Overlay metadata can be customized and toggled on/off via View → Overlay Tags Configuration or with the <code>Spacebar</code> key</li>
