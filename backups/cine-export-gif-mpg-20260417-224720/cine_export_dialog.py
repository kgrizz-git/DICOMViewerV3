    ...
    def __init__(
        ...
        *,
        ...
        self._format_combo.setToolTip(
            "MPG uses MPEG-2 in an MPEG program stream (FFmpeg), YUV 4:2:0. "
            "Some Windows editions need the optional MPEG-2 Video Extension for WMP. "
            "AVI uses MPEG-4 Part 2 (not PNG-in-AVI / MPNG)."
        )
