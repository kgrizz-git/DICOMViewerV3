...
class ExportManager:
    ...
    def _render_overlays_and_rois(
        ...
        if text_annotation_tool and study_uid and series_uid and slice_index is not None and config_manager:
            try:
                text_items = text_annotation_tool.get_annotations_for_slice(study_uid, series_uid, slice_index)
        ...
        if arrow_annotation_tool and study_uid and series_uid and slice_index is not None and config_manager:
            try:
                arrow_items = arrow_annotation_tool.get_arrows_for_slice(study_uid, series_uid, slice_index)
