...
class MprController(QObject):
    ...
    def __init__(self, app: Any) -> None:
        ...
        self._detached_mpr_payload: Optional[Dict[str, Any]] = None
        self._init_cache()
    ...
    def get_detached_mpr_thumbnail_pixels(self, use_rescaled: bool) -> Optional[np.ndarray]:
        """
    ...
    def _capture_mpr_payload(self, idx: int) -> Optional[Dict[str, Any]]:
