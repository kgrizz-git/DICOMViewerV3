...
def render_overlays_and_rois(
    ...
    if export_study_uid and export_series_uid and slice_index is not None:
        ...
        if rois:
            ...
            roi_line_thickness = export_line_thickness_pixels(
                roi_line_thickness_setting, width, height, anno_scale
            )
            roi_font_size = export_text_size_pixels(
    ...
    if export_study_uid and export_series_uid and slice_index is not None:
        ...
        if measurements:
            ...
            measurement_line_thickness = export_line_thickness_pixels(
                measurement_line_thickness_setting, width, height, anno_scale
            )
            measurement_font_size = export_text_size_pixels(
    ...
    if export_study_uid and export_series_uid and slice_index is not None and config_manager:
        ...
        try:
            if text_items:
                ...
                text_font_size = export_text_size_pixels(
    ...
    if export_study_uid and export_series_uid and slice_index is not None and config_manager:
        ...
        if arrow_items:
            try:
                ...
                arrow_thickness = export_line_thickness_pixels(
