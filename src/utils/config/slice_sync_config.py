...
class SliceSyncConfigMixin:
    ...
    def get_slice_sync_enabled(self) -> bool:
        ...
        """
        return bool(self._config().get("slice_sync_enabled", False))
    ...
    def set_slice_sync_enabled(self, enabled: bool) -> None:
        ...
        """
        self._config()["slice_sync_enabled"] = bool(enabled)
        self._save_config()
    ...
    def get_slice_sync_groups(self) -> List[List[int]]:
        ...
        """
        raw = self._config().get("slice_sync_groups", [])
    ...
    def set_slice_sync_groups(self, groups: List[List[int]]) -> None:
        ...
        self._config()["slice_sync_groups"] = cleaned
        self._save_config()
    ...
    def get_slice_location_lines_visible(self) -> bool:
        ...
        """
        return bool(self._config().get("slice_location_lines_visible", False))
    ...
    def set_slice_location_lines_visible(self, visible: bool) -> None:
        ...
        """
        self._config()["slice_location_lines_visible"] = bool(visible)
        self._save_config()
    ...
    def get_slice_location_lines_same_group_only(self) -> bool:
        ...
        """
        return bool(self._config().get("slice_location_lines_same_group_only", False))
    ...
    def set_slice_location_lines_same_group_only(self, same_group_only: bool) -> None:
        ...
        """
        self._config()["slice_location_lines_same_group_only"] = bool(same_group_only)
        self._save_config()
    ...
    def get_slice_location_lines_focused_only(self) -> bool:
        ...
        """
        return bool(self._config().get("slice_location_lines_focused_only", False))
