...
class MeasurementTool:
    ...
    def __init__(self, config_manager=None):
        ...
        self.current_end_point: QPointF | None = None  # Track last mouse position during measurement
        self.current_line_item: QGraphicsLineItem | None = None
        self.current_text_item: QGraphicsTextItem | None = None
        ...
        self.angle_p1: QPointF | None = None
        self.angle_p2: QPointF | None = None
        self.angle_preview_line1: QGraphicsLineItem | None = None
        self.angle_preview_line2: QGraphicsLineItem | None = None
        self.angle_preview_text: QGraphicsTextItem | None = None
    ...
    def set_pixel_spacing(self, pixel_spacing: tuple[float, float] | None) -> None:
        """
    ...
    def finish_measurement(self, scene) -> MeasurementItem | None:
        """
        ...
        temp_measurement_ref: dict[str, MeasurementItem | None] = {"measurement": None}
    ...
    def handle_angle_click(self, scene_pos: QPointF, scene) -> AngleMeasurementItem | None:
        """
    ...
    def update_all_measurement_text_offsets(self) -> None:
        ...
        """
        for _key, measurement_list in self.measurements.items():
            for measurement in measurement_list:
