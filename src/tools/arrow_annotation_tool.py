...
class ArrowAnnotationItem(QGraphicsItemGroup):
    ...
    def __init__(self, start_point: QPointF, end_point: QPointF,
        ...
        self.on_moved_callback: Callable[[ArrowAnnotationItem], None] | None = None
        self.on_mouse_release_callback: Callable[[ArrowAnnotationItem], None] | None = None
        self._drag_in_progress = False  # Flag to track if drag is in progress
        self._pre_move_start_point: QPointF | None = None
        self._pre_move_end_point: QPointF | None = None
        self._pre_drag_start_point: QPointF | None = None
        self._pre_drag_end_point: QPointF | None = None
    ...
    def _compute_directional_pixels_per_scene_unit(self, view: QGraphicsView, unit_x: float, unit_y: float) -> float | None:
        """
    ...
    def _set_line_end(self, view: QGraphicsView | None = None) -> None:
        """
    ...
    def update_line_end_for_view_scale(self, view: QGraphicsView | None = None) -> None:
        """
...
class ArrowAnnotationTool:
    ...
    def __init__(self, config_manager: ConfigManager | None = None):
        ...
        self.current_end_point: QPointF | None = None
        self.current_arrow_item: ArrowAnnotationItem | None = None
    ...
    def finish_arrow(self, scene) -> ArrowAnnotationItem | None:
        """
    ...
    def update_all_arrow_styles(self, config_manager: ConfigManager) -> None:
        ...
        for _key, arrow_list in self.arrows.items():
            for arrow in arrow_list:
