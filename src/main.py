...
class DICOMViewerApp(QObject):
    ...
    def _open_acr_mri_phantom_analysis(self) -> None:
        ...
        lc_method_default = self.config_manager.get_acr_mri_low_contrast_method()
        lc_vis_default = (
            self.config_manager.get_acr_mri_low_contrast_visibility_threshold()
        )
        lc_sanity_default = (
            self.config_manager.get_acr_mri_low_contrast_visibility_sanity_multiplier()
        )
        ...
        self.config_manager.set_acr_mri_low_contrast_visibility_sanity_multiplier(
            lc_sanity
        )
