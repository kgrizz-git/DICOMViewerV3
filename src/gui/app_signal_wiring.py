...
def _wire_dialog_signals(app: DICOMViewerApp) -> None:
    ...
    app.main_window.keyboard_shortcuts_requested.connect(app._on_keyboard_shortcuts_requested)
    app.main_window._apply_wl_preset_requested.connect(app._on_window_level_preset_selected)
    app.main_window.user_documentation_requested.connect(app._open_user_documentation_in_browser)
    ...
    app.main_window.acr_mri_batch_requested.connect(app._open_acr_mri_batch_analysis)
    ...
    app.main_window.deep_anonymizer_export_requested.connect(app._open_deep_anonymizer_export)
    app.main_window.export_screenshots_requested.connect(app._open_export_screenshots)
    app.main_window.save_mpr_dicom_requested.connect(app._on_save_mpr_as_dicom)
    app.main_window.export_cine_video_requested.connect(app._on_export_cine_video)
...
def _wire_undo_redo_and_annotation_signals(app: DICOMViewerApp) -> None:
    ...
    app.main_window.cut_annotation_requested.connect(
        app._annotation_paste_handler.cut_annotations
    )
...
def _wire_cine_signals(app: DICOMViewerApp) -> None:
    ...
    app.main_window.cine_play_pause_requested.connect(cine.on_cine_play_pause_toggle)
...
def _wire_view_signals(app: DICOMViewerApp) -> None:
    ...
    app.main_window.slice_slider_placement_changed.connect(app._on_slice_slider_placement_changed)
    app.main_window.slice_slider_direction_changed.connect(app._on_slice_slider_direction_changed)
    ...
    app.main_window.toggle_overlay_requested.connect(app.overlay_coordinator.handle_toggle_overlay)
