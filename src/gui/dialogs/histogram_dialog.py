...
HistogramRescaleParamsFn = Callable[[], tuple[float | None, float | None, Any]]
HistogramSeriesDatasetsFn = Callable[[], list[Dataset] | None]
HistogramStudiesFn = Callable[[], dict[str, Any] | None]
HistogramGeometryFn = Callable[[], tuple[int, int, int, int] | None]
HistogramSaveGeometryFn = Callable[[int, int, int, int], None]
HistogramProjectionPixelsFn = Callable[[], np.ndarray | None]
...
class HistogramDialog(QDialog):
    ...
    def __init__(
        ...
        get_window_center: Callable[[], float | None] | None = None,
        get_window_width: Callable[[], float | None] | None = None,
        get_use_rescaled: Callable[[], bool] | None = None,
        get_rescale_params: HistogramRescaleParamsFn | None = None,
        get_series_study_uid: Callable[[], str | None] | None = None,
        get_series_uid: Callable[[], str | None] | None = None,
        get_series_datasets: HistogramSeriesDatasetsFn | None = None,
        get_all_studies: HistogramStudiesFn | None = None,
        title_suffix: str = "",
        get_restore_geometry: HistogramGeometryFn | None = None,
        save_geometry_callback: HistogramSaveGeometryFn | None = None,
        get_projection_enabled: HistogramBoolFn | None = None,
        get_current_pixel_array: HistogramProjectionPixelsFn | None = None,
        ...
        self.series_global_x_max: float | None = None
        self.series_identity: tuple[Any, ...] | None = None
