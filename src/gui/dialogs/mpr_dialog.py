...
class MprDialog(QDialog):
    ...
    def __init__(
        ...
        initial_series_key: str | None = None,
    ...
    def _update_defaults(self) -> None:
        ...
        ps_tuple = get_pixel_spacing(ds0)
        default_sp = ps_tuple[0] if ps_tuple is not None else 1.0

        # Default slice thickness.
        st = get_slice_thickness(ds0)
        default_th = st if st is not None else default_sp
    ...
    def _current_series_key(self) -> str | None:
    ...
    def _button_box_ok(self) -> QPushButton | None:
    ...
    def _resolve_output_plane(self) -> tuple[SlicePlane | None, str]:
        """
