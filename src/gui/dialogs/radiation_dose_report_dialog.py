...
Shows :class:`core.rdsr_dose_sr.CtRadiationDoseSummary` for the current DICOM dose SR.
...
class RadiationDoseReportDialog(QDialog):
    """Modeless-capable dialog listing CT dose metrics from a parsed dose SR."""
    ...
    def __init__(
        ...
        *,
        ...
        self.setWindowTitle(f"Radiation dose report — {self._series_description}")
        self.setModal(False)
        self.resize(560, 420)
        ...
        self._hint = QLabel(
            "Parsed CT radiation dose summary. Export may contain identifiers unless "
