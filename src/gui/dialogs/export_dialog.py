...
class ExportDialog(QDialog):
    ...
    def _create_ui(self) -> None:
        ...
        anonymize_row.addWidget(self.anonymize_checkbox)
        self.anonymize_options_button = QPushButton("Options…")
        self.anonymize_options_button.setEnabled(False)
        self.anonymize_options_button.clicked.connect(self._open_anonymize_options)
    ...
    def _on_format_changed(self) -> None:
        ...
        self.anonymize_options_button.setEnabled(is_dicom_format and self.anonymize_checkbox.isChecked())
    ...
    def _open_anonymize_options(self) -> None:
        ...
        dialog = AnonymizationOptionsDialog(self.anonymizer_options, parent=self)
        if dialog.exec():
