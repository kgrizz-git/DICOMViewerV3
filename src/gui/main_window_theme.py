...
_THEMES_DIR = Path(__file__).parent.parent.parent / "resources" / "themes"
...
def get_theme_stylesheet(
    ...
    two checkmark image paths before returning.
    ...
    """
    qss_file = _THEMES_DIR / f"{theme}.qss"
    if not qss_file.exists():
        qss_file = _THEMES_DIR / "light.qss"
