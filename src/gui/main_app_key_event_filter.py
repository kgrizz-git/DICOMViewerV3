...
def _escape_may_exit_fullscreen(app: Any) -> bool:
    ...
    if isinstance(fw, (QLineEdit, QTextEdit, QPlainTextEdit)):
        return False
    return not isinstance(fw, QAbstractSpinBox)


def is_widget_allowed_for_layout_shortcuts(app: Any, widget: Any | None) -> bool:
    """
...
def dispatch_app_key_event(app: Any, event: Any) -> bool | None:
    """
