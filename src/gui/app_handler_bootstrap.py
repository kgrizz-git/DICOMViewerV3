...
def initialize_handlers(app: DICOMViewerApp) -> None:
    ...
    app.file_operations_handler = FileOperationsHandler(
        ...
        pipeline_complete_callback=app._file_series_coordinator._on_load_complete,
    )
    ...
    app.keyboard_event_handler = KeyboardEventHandler(
        ...
        cycle_three_pane_layout_callback=app.multi_window_layout.cycle_three_pane_layout,
        toggle_two_pane_layout_callback=app.multi_window_layout.toggle_two_pane_layout,
