...
class ROIListPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.roi_delete_callback: Callable[[ROIItem], None] | None = None
        self.delete_all_rois_callback: Callable[[], None] | None = None
        self.roi_statistics_overlay_toggle_callback: Callable[[ROIItem, bool], None] | None = None
        self.roi_statistics_selection_callback: Callable[[ROIItem, str, bool], None] | None = None
        self.annotation_options_callback: Callable[[], None] | None = None
    ...
    def _create_ui(self) -> None:
        ...
        self.delete_button.clicked.connect(self._delete_selected_roi)
        self.delete_button.setEnabled(False)
        button_layout.addWidget(self.delete_button)

        self.delete_all_button = QPushButton("Delete All")
        self.delete_all_button.clicked.connect(self._delete_all_rois)
    ...
    def update_roi_list(self, study_uid: str, series_uid: str, instance_identifier: int, roi_manager: ROIManager | None = None) -> None:
        """
        ...
        current_item.text() if current_item else None
    ...
    def _update_button_states(self) -> None:
        """Enable/disable Delete buttons based on list and selection state."""
        has_any = self.roi_list.count() > 0
        has_selection = self.roi_list.currentItem() is not None
        self.delete_button.setEnabled(has_selection)
        self.delete_all_button.setEnabled(has_any)
    ...
    def select_roi_in_list(self, roi: ROIItem | None) -> None:
        """
