...
def apply_initial_image_viewer_display_state(app: Any) -> None:
    ...
    slider_placement = app.config_manager.get_slice_slider_placement()
    slider_direction = app.config_manager.get_slice_slider_direction()
    ...
    for viewer in _iter_image_viewers(app):
        ...
        viewer.set_slice_slider_options(slider_placement, slider_direction)
...
def set_slice_slider_options_all(app: Any, placement: str, direction: str) -> None:
    """Propagate slice/frame slider placement and direction to every subwindow."""
    for viewer in _iter_image_viewers(app):
        viewer.set_slice_slider_options(placement, direction)
