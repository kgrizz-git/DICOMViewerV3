...
from core.slice_grouping import get_total_slices as get_total_slice_groups
...
class CinePlayer(QObject):
    ...
    def __init__(self, slice_navigator, get_total_slices_callback, get_current_slice_callback):
        ...
        self.current_studies: dict[str, Any] | None = None
        self.current_study_uid: str | None = None
        self.current_series_uid: str | None = None

        # Datasets for slice-aware navigation
        self.current_datasets: list[Dataset] | None = None
    ...
    def set_series_context(
        self, studies: dict[str, Any] | None, study_uid: str | None, series_uid: str | None
    ) -> None:
        """
    ...
    def get_frame_rate_from_dicom(self, dataset: Dataset) -> float | None:
        """
    ...
    def start_playback(self, frame_rate: float | None = None, dataset: Dataset | None = None) -> bool:
        """
        Start cine playback.
