...
class OverlayCoordinator:
    ...
    def __init__(
        ...
        get_multiframe_overlay_context: Callable[[Dataset | None, str | None, str | None], dict[str, Any] | None] | None = None,
        hide_measurement_labels: Callable[[bool], None] | None = None,
        hide_measurement_graphics: Callable[[bool], None] | None = None,
        hide_roi_graphics: Callable[[bool], None] | None = None,
        hide_roi_statistics_overlays: Callable[[bool], None] | None = None
    ):
        """
    ...
    def handle_toggle_overlay(self) -> None:
        ...
        if current_dataset is not None and self.image_viewer.scene is not None:
            ...
            stack_position = (
                ...
                if total_slices and 0 <= current_slice_index < total_slices
                else None
            )
            self.overlay_manager.create_overlay_items(
                self.image_viewer.scene,
